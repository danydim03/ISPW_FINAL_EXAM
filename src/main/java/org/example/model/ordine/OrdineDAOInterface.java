...
public interface OrdineDAOInterface {
     ...
     * @throws ResourceNotFoundException risorsa properties non trovata
     */
    void update(Ordine ordine) throws DAOException, PropertyException, ResourceNotFoundException, MissingAuthorizationException;
     ...
     * @throws ResourceNotFoundException risorsa properties non trovata
     */
    List<Ordine> getOrdiniByCliente(String clienteId) throws DAOException, PropertyException, ResourceNotFoundException,
     ...
     * @throws ResourceNotFoundException risorsa properties non trovata
     */
    List<Ordine> getOrdiniByStato(StatoOrdine stato) throws DAOException, PropertyException, ResourceNotFoundException,
            UserNotFoundException, UnrecognizedRoleException, ObjectNotFoundException, MissingAuthorizationException, WrongListQueryIdentifierValue;
