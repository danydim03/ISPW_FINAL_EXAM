...
public interface FoodDAOInterface {
     ...
     */
    void insert(Food food) throws DAOException, PropertyException, ResourceNotFoundException, MissingAuthorizationException;
     ...
     * @throws ResourceNotFoundException risorsa properties non trovata
     */
    void update(Food food) throws DAOException, PropertyException, ResourceNotFoundException, MissingAuthorizationException;
     ...
     * @throws ResourceNotFoundException risorsa properties non trovata
     */
    Food getFoodById(Long id) throws DAOException, ObjectNotFoundException, PropertyException, ResourceNotFoundException, 
