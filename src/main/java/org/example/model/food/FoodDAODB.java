...
public class FoodDAODB extends DAODBAbstract<Food> implements FoodDAOInterface {
    ...
    @Override
    public Food getFoodById(Long id) throws DAOException, ObjectNotFoundException, PropertyException, ResourceNotFoundException, 
    ...
    @Override
    public void insert(Food food) throws DAOException, PropertyException, ResourceNotFoundException, MissingAuthorizationException {
        insertQuery(
                FOOD,
                List.of(
                        food.getDescrizione(),
    ...
    @Override
    public void update(Food food) throws DAOException, PropertyException, ResourceNotFoundException, MissingAuthorizationException {
        updateQuery(
                FOOD,
                List.of(DESCRIZIONE, TIPO, CLASSE, COSTO, DURATA),
                List.of(food.getDescrizione(), food. getTipo(), food.getClass().getSimpleName(), food. getCosto(), food.getDurata()),
                List.of(ID),
                List.of(food. getId())
        );
    }
